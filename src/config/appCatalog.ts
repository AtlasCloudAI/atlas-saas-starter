...
export const PRODUCTION_ROUTES = new Set<string>([
  '/sku-studio', '/course-studio', '/comic-studio', '/image-to-3d', '/text-to-3d', '/game-asset-3d', '/figurine-3d', '/memorial-figurine',
  '/video-edit', '/video-upscale', '/course-video', '/podcast', '/ecommerce-suite', '/kids-book',
]);

// ⭐ 精品:重点打磨、可对外主推的旗舰应用
export const FEATURED_ROUTES = new Set<string>(['/sku-studio', '/course-studio', '/comic-studio']);
